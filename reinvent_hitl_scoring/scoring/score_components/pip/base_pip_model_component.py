...
from reinvent_hitl_scoring.scoring.enums import EnvironmentalVariablesEnum
from reinvent_hitl_scoring.scoring.score_components.pip.base_rest_component import BaseRESTComponent
...
class BasePiPModelComponent(BaseRESTComponent):
    ...
    def _retrieve_pip_key_from_config(self, variable: str) -> str:
        try:
            environmental_variables = reinvent_hitl_scoring_config[self._environment_keys.ENVIRONMENTAL_VARIABLES]
